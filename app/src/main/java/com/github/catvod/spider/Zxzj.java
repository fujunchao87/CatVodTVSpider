...
public class Zxzj extends Spider {
    ...
    private static final String siteUrl = "https://www.zxzj.vip";
    private static final String siteHost = "www.zxzj.vip";
    ...
    public String homeContent(boolean filter) {
        try {
            Document doc = Jsoup.parse(OkHttpUtil.string("https://www.zxzj.vip", getHeaders(siteUrl)));
    ...
    public String detailContent(List<String> ids) {
        try {
            String url = "https://www.zxzj.vip/detail/" + ids.get(0) + ".html";
                    ...
                    if (playerConfig.has(string)) {
                        if (!"xunleiyp".equals(string) && !"yunpan".equals(string)) {
                            ...
                            if (!TextUtils.isEmpty(string2)) {
                                ...
                                hashMap.put("Referer", "https://www.zxzj.vip");
