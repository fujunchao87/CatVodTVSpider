...
public class Zxzj extends Spider {
    ...
    private static final String siteUrl = "https://www.zxzjtv.vip";
    private static final String siteHost = "www.zxzjtv.vip";
    ...
    public String homeContent(boolean filter) {
        try {
            Document doc = Jsoup.parse(OkHttpUtil.string("https://www.zxzjtv.vip", getHeaders(siteUrl)));
    ...
    public String detailContent(List<String> ids) {
        try {
            String url = "https://www.zxzjtv.vip/detail/" + ids.get(0) + ".html";
                    ...
                    if (playerConfig.has(string)) {
                        if (!"xunleiyp".equals(string) && !"yunpan".equals(string)) {
                            ...
                            if (!TextUtils.isEmpty(string2)) {
                                ...
                                hashMap.put("Referer", "https://www.zxzjtv.vip");
